...
function PanelControl({ closePanel }) {
            ...
            >
                ...
                <li className="first-list">
                    ...
                    <div className="collapsible-body" style={{ borderBottom: "none" }}>
                        <ul className="side-nav-panel">
                            <li>
                                <Link to="/cardList" onClick={closePanel}>카드 조회</Link>
                            </li>
                            <li>
                                <Link to="/cardUsage" onClick={closePanel}>카드 사용 내역</Link>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div className="collapsible-body" style={{ borderBottom: "none" }}>
                        <ul className="side-nav-panel">
                            <li>
                                <Link to="/themeSearchAll" onClick={closePanel}>테마 조회</Link>
                            </li>
                            <li>
                                <Link to="/startBucket" onClick={closePanel}>테마 추천 받기</Link>
                            </li>
                            <li>
                                <Link to="/themeRegister" onClick={closePanel}>테마 등록</Link>
                            </li>
                            <li>
                                <Link to="/SearchRaid" onClick={closePanel}>레이드조회</Link>
                            </li>
                            <li>
                                <Link to="/raidHistory" onClick={closePanel}>레이드 내역 조회</Link>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div className="collapsible-body" style={{ borderBottom: "none" }}>
                        <ul className="side-nav-panel">
                            <li>
                                <Link to="/point" onClick={closePanel}>포인트 관리</Link>
                            </li>
                            <li>
                                <Link to="/coupon" onClick={closePanel}>쿠폰 관리</Link>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    {/* 이벤트 섹션 (현재 주석 처리되어 있음) */}
                </li>
            </ul>
        </div>
    );
